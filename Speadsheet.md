...
on this report , we will know the  steps and the procedures to  create a complete spreadsheet with its own tools  , more details in the sections below.
...
```
>we add the tools that we've seen in the previous code, after the creation of our interface.
...
```
>  by typing the correct regular expression we will find any cell we want .
...
```
> Search for any data inside our spreadsheet .
# Conclusion 

In our interface home-machine classes we learn how to create a spreadsheet , by using 'UI Widgets' .
